...
def run_server(tp_rank, world_size, port, ready_queue, max_batch_size, config, model_path, max_total_length, mem_usage, max_input_length, use_radix_cache):
    sys.stdin = open('/dev/tty', 'r')
    service = ModelServerRpc(max_batch_size=max_batch_size, max_input_length=max_input_length, config=config, model_path=model_path, max_total_length=max_total_length, mem_usage=mem_usage, tp_rank=tp_rank, world_size=world_size, use_radix_cache=use_radix_cache)
