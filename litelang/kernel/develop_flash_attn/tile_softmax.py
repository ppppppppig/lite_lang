...
m_pre, l_pre = update_softmax_block(
    test_tensor_block1, m_pre, l_pre, all_softmax_tensor, 0
)

# Block 2
test_tensor_block2 = torch.tensor([2], dtype=torch.float32)
m_pre, l_pre = update_softmax_block(
    test_tensor_block2, m_pre, l_pre, all_softmax_tensor, 1
)
...
m_pre, l_pre = update_softmax_block(
    test_tensor_block3, m_pre, l_pre, all_softmax_tensor, 2
)
