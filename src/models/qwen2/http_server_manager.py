...
class HttpServerManager:
    ...
    def __init__(self, model_path, max_req_length, max_batch_size, device):
        ...
        self.model = Qwen2Model(config.layer_nums, max_req_length, config)
    ...
    def generate(self, prompt):
        ...
        req = self.req_manager_.Add(prompt)
