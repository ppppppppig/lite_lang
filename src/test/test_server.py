...
def run_server(model_path, max_output_length, max_batch_size, max_input_length, tp, port, mem_usage, max_reqs, busy_scale, use_radix_cache):
    http_server_manager = HttpServerManager(model_path, max_input_length, max_output_length, max_batch_size, mem_usage, tp, max_reqs, busy_scale, use_radix_cache)
